  ...
  root.innerHTML = `
    <div class="auth-wrap">
      <div class="auth-card card">
        ...
        <form id="authForm">
          <div class="fld"><label for="authEmail">Correo</label><input id="authEmail" type="email" required autocomplete="email"></div>
          ${mode !== 'recuperar' ? '<div class="fld"><label for="authPass">Contraseña</label><input id="authPass" type="password" required autocomplete="current-password" minlength="6"></div>' : ''}
